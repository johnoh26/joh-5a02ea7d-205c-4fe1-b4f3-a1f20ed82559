...
let AuthService = class AuthService {
    ...
    login(email, password) {
        return (0,external_tslib_namespaceObject.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (!user) {
                throw new common_.BadRequestException('Invalid credentials');
            }
...
(0,external_tslib_namespaceObject.__decorate)([
    (0,common_.Post)('login'),
    (0,external_tslib_namespaceObject.__param)(0, (0,common_.Body)('email')),
    (0,external_tslib_namespaceObject.__param)(1, (0,common_.Body)('password')),
    (0,external_tslib_namespaceObject.__metadata)("design:type", Function),
