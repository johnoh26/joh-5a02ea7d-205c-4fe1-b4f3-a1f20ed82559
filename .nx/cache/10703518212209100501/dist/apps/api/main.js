...
var user_entity_a, user_entity_b;
...
(0,external_tslib_namespaceObject.__decorate)([
    ...
    (0,external_tslib_namespaceObject.__metadata)("design:type", typeof (user_entity_b = typeof Organization !== "undefined" && Organization) === "function" ? user_entity_b : Object)
...
var task_controller_a, task_controller_b, _c, _d, _e, _f, _g, _h;
...
(0,external_tslib_namespaceObject.__decorate)([
    ...
    (0,external_tslib_namespaceObject.__metadata)("design:returntype", typeof (_c = typeof Promise !== "undefined" && Promise) === "function" ? _c : Object)
    ...
    (0,common_namespaceObject.Module)({
        imports: [
            ...
            typeorm_namespaceObject.TypeOrmModule.forRoot({
                ...
                password: 'postgres',
                database: 'postgres',
                entities: [__dirname + '../../../../dist/libs/src/data/*.entity{.js,.ts}'],
                synchronize: true,
                logging: true,
            }),
            UsersModule,
