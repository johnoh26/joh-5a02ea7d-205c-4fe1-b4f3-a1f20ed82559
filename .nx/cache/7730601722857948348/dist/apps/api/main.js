    ...
    (0,common_namespaceObject.Module)({
        imports: [
            ...
            typeorm_namespaceObject.TypeOrmModule.forRoot({
                ...
                password: 'postgres',
                database: 'postgres',
                // Avoid relying on file globs which can fail when bundling —
                // autoLoadEntities will register entities added via TypeOrmModule.forFeature()
                // autoLoadEntities: true,
                entities: process.env.NODE_ENV === 'production'
                    ? [__dirname + '../../../../dist/libs/src/**/*.entity{.js,.d.ts}']
                    : [__dirname + '../../../../dist/libs/src/**/*.entity{.js,.d.ts}'],
                synchronize: true,
                logging: true,
            }),
